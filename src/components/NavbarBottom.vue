  ...
  >
    <router-link to="/members">
      <div class="flex flex-col items-center cursor-pointer hidden">
        <svg
          ...
          aria-hidden="true"
          role="img"
          :class="this.$route.name == 'Members' ? 'activeNav' : ''"
          class="iconify iconify--ant-design text-white"
          width="28"
          height="28"
    ...
    <router-link to="/Product">
      <div class="flex flex-col items-center cursor-pointer">
        <svg
          ...
          aria-hidden="true"
          role="img"
          :class="this.$route.name == 'Product' ? 'activeNav' : ''"
    ...
    <router-link to="/Contact">
      <div class="flex flex-col items-center cursor-pointer">
        <svg
          ...
          aria-hidden="true"
          role="img"
          :class="this.$route.name == 'Contact' ? 'activeNav' : ''"
    ...
    <div class="flex flex-col items-center cursor-pointer hidden">
      <svg
        ...
        aria-hidden="true"
        role="img"
        class="iconify iconify--mdi text-white"
        width="28"
        height="28"
        preserveAspectRatio="xMidYMid meet"
        viewBox="0 0 24 24"
